...
//TODO delete?
    public static String getPhantomeJSPath() {
        String basePath = getDriversDir();
        ...
        if (SystemUtils.IS_OS_WINDOWS) {
            ...
            return Paths.get(basePath,"phantomjs.exe").toString();

        }
        if (SystemUtils.IS_OS_LINUX) {
            return Paths.get(basePath,"phantomjs_linux").toString();
