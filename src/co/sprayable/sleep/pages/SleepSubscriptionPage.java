...
public class SleepSubscriptionPage extends BasePage{
...
//            "//a[@class='js_orderButton no-close-popup']//div[contains(text(),'SUBSCRIBE NOW')]");
 private Locator linkSubscribeNowHeader = new Locator(LocatorTypes.XPATH,
            "//div[@id='order_page_top']//../following-sibling::*[7]//a");
    ...
    scrollToHeaderLinkSubscribeNow() {
        scrollToElement("scroll to 'SubscribeNowHeader' button", linkSubscribeNowHeader);
    }
