...
public class SprayablePage extends BasePage {
    ...
    private Locator sprayEnergySection = new Locator(LocatorTypes.XPATH, "//img[contains(@src,'assets/img02')]");
    ...
    public void clickLinkOrderNowEnergy() {
        scrollToElement("scroll to 'Order Now' button in energy section", sprayEnergySection);
