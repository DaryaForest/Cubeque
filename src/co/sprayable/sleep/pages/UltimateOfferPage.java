...
public class UltimateOfferPage extends BasePage {
    ...
    private Locator footerPageOffer = new Locator(LocatorTypes.XPATH, "//div[@class = 'row customers']");
    ...
    public void clickFooterLinkBuyNow() {
        ...
        waitToBeClickable("waiting for footer link 'Buy Now' become clickable", linkBuyNow);
        click("click footer link 'Buy Now'", linkBuyNow);
    }
