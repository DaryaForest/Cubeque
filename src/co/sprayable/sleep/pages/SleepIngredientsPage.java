...
public class SleepIngredientsPage extends BasePage {
    private Locator middle25Off = new Locator(LocatorTypes.XPATH, "//a[contains(text(),'Click Here to Buy Sprayable Today (25% OFF for few hours)')]");
    private Locator footer25Off = new Locator(LocatorTypes.XPATH, "//a[contains(text(),'Buy It Now To Get Sprayable 25% OFF')]");
