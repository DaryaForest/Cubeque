...
public class SpecialOfferForSprayableEnergyPage extends BasePage {
    ...
    private Locator getSprayableEnergyFor25OffButton = new Locator(LocatorTypes.XPATH, "//div[contains(@class, 'layout')][4]//div[@class='btn-container']");
    ...
    public void waitSprayableEnergyFor25OffButton(){
        scrollToElement("scroll to 'Get Sprayable energy for 25% OFF' button", getSprayableEnergyFor25OffButton);
