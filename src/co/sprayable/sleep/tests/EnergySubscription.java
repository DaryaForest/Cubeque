...
public class EnergySubscription extends BaseTest{
    ...
    @Test
    public void testEnergySubscription(){
        Actions.mainActions().clearSession();
        Actions.mainActions().openPage(Constants.ENERGY_ORDER_SUBSCRIPTION);
        Actions.mainActions().wait(Constants.MINIMUM_TIMEOUT_SECONDS);

        Actions.sleepSleepSubscriptionActions().subscribeNowButtClick();
        Actions.mainActions().wait(Constants.MINIMUM_TIMEOUT_SECONDS);
        ...
        Assert.assertTrue(Pages.thankyouPage().isConfirmOrderMessagePressent(),
                "Thank you page is not opened.");
