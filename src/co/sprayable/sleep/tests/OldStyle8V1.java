...
public class OldStyle8V1 extends BaseTest {
    ...
    public void OldStyle8V11() {
        ...
        Actions.noMoreJetLagActions().middlePageButtonClick();
    ...
    @Test
    public void OldStyle8V12() {
        Actions.mainActions().clearSession();
        Actions.mainActions().openPage(Constants.NO_MORE_JET_LAG_URL);
        Actions.mainActions().wait(Constants.MINIMUM_TIMEOUT_SECONDS);
        Actions.noMoreJetLagActions().footerBuyItNowClick();
