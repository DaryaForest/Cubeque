...
public class Sprayable6Months extends BaseTest {
    ...
    @Test
    public void testSprayable6Months() {
        Actions.mainActions().clearSession();
        Actions.mainActions().openPage(Constants.SPRAYABLE_6_MONTHS);

        Pages.sprayable6MonthsPage().waitBuyNowButton();
        Pages.sprayable6MonthsPage().clickBuyNowButton();
