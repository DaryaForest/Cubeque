...
public class SprayableNotEnoughtSleep extends BaseTest{
    ...
    @Test
    public void SprayableNotEnoughtSleep1() {
        Actions.mainActions().clearSession();
        Actions.mainActions().openPage(Constants.SLEEP_LANDING_NOT_ENOUGH_SLEEP);
        Actions.mainActions().wait(Constants.SMALL_TIMEOUT_SECONDS);
        Actions.sprayableNotEnoughtSleepActions().clickMiddlePageButton();
    ...
    @Test
    public void SprayableNotEnoughtSleep2() {
        Actions.mainActions().clearSession();
        Actions.mainActions().openPage(Constants.SLEEP_LANDING_NOT_ENOUGH_SLEEP);
        Actions.mainActions().wait(Constants.SMALL_TIMEOUT_SECONDS);
        Actions.sprayableNotEnoughtSleepActions().clickFooterPageButton();
    ...
    @Test
    public void SprayableNotEnoughtSleep3() {
        Actions.mainActions().clearSession();
        Actions.mainActions().openPage(Constants.SLEEP_LANDING_NOT_ENOUGH_SLEEP);
        Actions.mainActions().wait(Constants.SMALL_TIMEOUT_SECONDS);
        Actions.sprayableNotEnoughtSleepActions().clickMiddlePageButton();
