...
public class SleepEnergySubscription extends BaseTest {
    ...
    @Test
    public void testSleepEnergySubscriptionV1() {
        Actions.mainActions().clearSession();
        Actions.mainActions().openPage(Constants.CIRCADIAN_PRODUCT_ORDER);
    ...
    @Test
    public void testSleepEnergySubscriptionV2() {
        Actions.mainActions().clearSession();
        Actions.mainActions().openPage(Constants.CIRCADIAN_PRODUCT_ORDER);
        Actions.mainActions().wait(Constants.SMALL_TIMEOUT_SECONDS);
    ...
    @Test
    public void testSleepEnergySubscriptionV3() {
        Actions.mainActions().clearSession();
        Actions.mainActions().openPage(Constants.CIRCADIAN_PRODUCT_ORDER);
        Actions.mainActions().wait(Constants.SMALL_TIMEOUT_SECONDS);
