...
public class SprayableV2 extends BaseTest {
    ...
    public void testSprayableV2() {
        ...
        Assert.assertTrue(driver().getCurrentUrl().contains(Constants.SPRAYABLE_ORDER_ENERGY_URL), "Expected URL: " + Constants.SPRAYABLE_ORDER_ENERGY_URL + ". Current URL: " + driver().getCurrentUrl() + "\n");
        Actions.orderEnergyAction().clickTopLinkBuyNowEnergy();
     ...
     // Pages.sprayablePage().waitLinkOrderNowDisappear();
        ...
        Assert.assertTrue(driver().getCurrentUrl().contains(Constants.SPRAYABLE_ORDER_ENERGY_URL), "Expected URL: " + Constants.SPRAYABLE_ORDER_ENERGY_URL + ". Current URL: " + driver().getCurrentUrl() + "\n");
        Actions.orderEnergyAction().clickMiddleBuyNowButton();
        Actions.mainActions().wait(Constants.MINIMUM_TIMEOUT_SECONDS);
        Assert.assertTrue(driver().getCurrentUrl().contains(Constants.SPRAYABLE_ORDER_ENERGY_URL), "Expected URL: " + Constants.SPRAYABLE_ORDER_ENERGY_URL + ". Current URL: " + driver().getCurrentUrl() + "\n");
        ...
        Assert.assertTrue(driver().getCurrentUrl().contains(Constants.SPRAYABLE_ORDER_ENERGY_URL), "Expected URL: " + Constants.SPRAYABLE_ORDER_ENERGY_URL + ". Current URL: " + driver().getCurrentUrl() + "\n");
        Actions.orderEnergyAction().clickFooterLinkBuyNowEnergy();
        Actions.mainActions().wait(Constants.MINIMUM_TIMEOUT_SECONDS);
        Assert.assertTrue(driver().getCurrentUrl().contains(Constants.CHECKOUT_URL), "Expected URL: " + Constants.CHECKOUT_URL + ". Current URL: " + driver().getCurrentUrl() + "\n");
