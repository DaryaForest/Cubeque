...
public class DelayedShippingSleep extends BaseTest {
    ...
    @Test
    public void DelayedShippingSleepV1() {
        Actions.mainActions().clearSession();
        Actions.mainActions().openPage(Constants.SUBSCRIBER_OFFER_URL);
    ...
    @Test
    public void DelayedShippingSleepV2() {
        Actions.mainActions().clearSession();
        Actions.mainActions().openPage(Constants.SUBSCRIBER_OFFER_URL);
        Actions.mainActions().wait(Constants.MINIMUM_TIMEOUT_SECONDS);
    ...
    @Test
    public void DelayedShippingSleepV3() {
        Actions.mainActions().clearSession();
        Actions.mainActions().openPage(Constants.SUBSCRIBER_OFFER_URL);
        Actions.mainActions().wait(Constants.MINIMUM_TIMEOUT_SECONDS);
    ...
    @Test
    public void DelayedShippingSleepV4() {
        Actions.mainActions().clearSession();
        Actions.mainActions().openPage(Constants.SUBSCRIBER_OFFER_URL);
        Actions.mainActions().wait(Constants.MINIMUM_TIMEOUT_SECONDS);
