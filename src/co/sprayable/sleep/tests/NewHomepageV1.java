...
public class NewHomepageV1 extends BaseTest {
    ...
    public void testNewHomepageV11() {
        ...
        Actions.homeNewActions().cleanseYourCircadianRhythmButClick();
        Actions.mainActions().wait(Constants.SMALL_TIMEOUT_SECONDS);
    ...
    public void testNewHomepageV12() {
        ...
        Actions.homeNewActions().ClickHereToGetTheCircadianCleanseButClick();
        Actions.mainActions().wait(Constants.SMALL_TIMEOUT_SECONDS);
        Assert.assertTrue(driver().getCurrentUrl().contains(Constants.CHECKOUT_URL), "Expected URL: " + Constants.CHECKOUT_URL + ". Current URL: " + driver().getCurrentUrl() + "\n");
    ...
    public void testNewHomepageV13() {
        ...
        Actions.homeNewActions().LiveALongerButClick();
        Actions.mainActions().wait(Constants.SMALL_TIMEOUT_SECONDS);
        Assert.assertTrue(driver().getCurrentUrl().contains(Constants.CHECKOUT_URL), "Expected URL: " + Constants.CHECKOUT_URL + ". Current URL: " + driver().getCurrentUrl() + "\n");
