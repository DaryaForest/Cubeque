...
public class Sprayablesleep1 extends BaseTest {
    ...
    public void testSprayablesleep1 () {
        ...
        Assert.assertTrue(driver().getCurrentUrl().contains(Constants.ORDER_FREE_TRIAL_CO_URL), "Expected URL: " + Constants.ORDER_FREE_TRIAL_CO_URL + ". Current URL: " + driver().getCurrentUrl() + "\n");
