...
public class GrandSprayableV1 extends BaseTest {
    ...
    private void genTestData() {
        ...
        @Test
        public void grandSprayV1() {

            Actions.mainActions().clearSession();
            Actions.mainActions().openPage(Constants.GRAND_SPRAYABLE_SLEEP);
            Actions.mainActions().wait(Constants.MINIMUM_TIMEOUT_SECONDS);

            Actions.grandSprayableSleepActions().middlePageButtonClick();
        ...
        @Test
        public void grandSprayV2() {

            Actions.mainActions().clearSession();
            Actions.mainActions().openPage(Constants.GRAND_SPRAYABLE_SLEEP);
            Actions.mainActions().wait(Constants.MINIMUM_TIMEOUT_SECONDS);
            Actions.grandSprayableSleepActions().footerBuyItNowClick();
