...
public class OldStyle2V1 extends BaseTest {
    ...
    public void OldStyle31() {
        ...
        Actions.getSleepTwoActions().clickReadyToBuyNow();
        Actions.mainActions().wait(Constants.SMALL_TIMEOUT_SECONDS);
        Assert.assertTrue(driver().getCurrentUrl().contains(Constants.GET_SLEEP_TWO_URL), "Expected URL: " + Constants.GET_SLEEP_TWO_URL + ". Current URL: " + driver().getCurrentUrl() + "\n");
    ...
    public void OldStyle32() {
        ...
        Actions.getSleepTwoActions().clickBuyNow();
    ...
    public void OldStyle33() {
        ...
        Actions.getSleepTwoActions().clickFooterBuyNow();
        Assert.assertTrue(driver().getCurrentUrl().contains(Constants.CHECKOUT_URL), "Expected URL: " + Constants.CHECKOUT_URL + ". Current URL: " + driver().getCurrentUrl() + "\n");
        Actions.checkoutAction().checkOutOrder(orderData);
        Actions.mainActions().wait(Constants.SMALL_TIMEOUT_SECONDS);
