...
public class SleepHackerActions extends BaseActions {
    ...
    public void middlePageButtonClick(){
        Pages.sleepHackerPage().scrollToMiddleBuySpray();
        Pages.sleepHackerPage().clockToMiddleBuySpray();
    }

    public void footerBuyItNowClick(){
        Pages.sleepHackerPage().scrollToFooterBuyItNow();
        Pages.sleepHackerPage().clickToFooterBuyItNow();
    }
