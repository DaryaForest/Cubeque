...
public class GetFreeTrialActions extends BaseActions {
    ...
    public void clickReadyToBuyNow(){
        Pages.getFreeTrialPage().scrollToLinkReadyToBuyNow();
        Pages.getFreeTrialPage().clickLinkReadyToBuyNow();
    }

    public void clickOrderSprayableNow(){
        Pages.getFreeTrialPage().scrollToLinkOrderSprayNow();
        Pages.getFreeTrialPage().clickLinkOrderSprayNow();
    }

    public void clickFooterBuyNow(){
        Pages.getFreeTrialPage().scrollToFooterPage();
        Pages.getFreeTrialPage().clickLinkBuyNow();
    }
