...
public class LimitedTimeOfferActions extends BaseActions {
    ...
    public void clickBuyNow(){
        Pages.limitedTimeOfferPage().clickLinkBuyNow();
    }

    public void clickReadyToBuyNow(){
        Pages.limitedTimeOfferPage().scrollToLinkReadyToBuyNow();
        Pages.limitedTimeOfferPage().clickLinkReadyToBuyNow();
    }

    public void clickFooterBuyNow(){
        Pages.limitedTimeOfferPage().clickFooterLinkBuyNow();
    }

    public boolean isUpperTitleEnable(){
        wait(2);
        return Pages.limitedTimeOfferPage().isUpperTitleVisible();
    }
}
