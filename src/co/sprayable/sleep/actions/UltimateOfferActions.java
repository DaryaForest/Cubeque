...
public class UltimateOfferActions extends BaseActions {
    ...
    public void clickBuyNow(){
        Pages.ultimateOfferPage().clickLinkBuyNow();
    }

    public void clickReadyToBuyNow(){
        Pages.ultimateOfferPage().scrollToLinkReadyToBuyNow();
        Pages.ultimateOfferPage().clickLinkReadyToBuyNow();
    }

    public void clickFooterBuyNow(){
        Pages.ultimateOfferPage().clickFooterLinkBuyNow();
    }

    public boolean isUpperTitleEnable(){
        wait(2);
        return Pages.ultimateOfferPage().isUpperTitleVisible();
    }
}