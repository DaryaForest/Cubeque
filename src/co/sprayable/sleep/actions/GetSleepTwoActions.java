...
public class GetSleepTwoActions extends BaseActions {
    public void clickBuyNow(){
        Pages.getFreeTrialPage().clickLinkBuyNow();
    }

    public void clickReadyToBuyNow(){
        Pages.getSleepTwoPage().scrollToLinkReadyToBuyNow();
        Pages.getSleepTwoPage().clickLinkReadyToBuyNow();
    }

    public void clickOrderSprayableNow(){
        Pages.getSleepTwoPage().scrollToLinkOrderSprayNow();
        Pages.getSleepTwoPage().clickLinkOrderSprayNow();
    }

    public void clickFooterBuyNow(){
        Pages.getSleepTwoPage().scrollToFooterPage();
        Pages.getSleepTwoPage().clickLinkBuyNow();
    }
